...
/**
 * Логирует данные, заполненные пользователем в форме резюме в базу данных.
 * Кандидат на рефакторинг: логика записи в БД достаточно запутана, нет четких контрактов,
 * в базу может записаться нежелательная информация.
 * В будущем следует:
 * - экранировать пользовательские данные
 * - четко описать контракты
 * - сделать единый низкоуровненый слой записи данных в БД (генерация запросов).
 */
